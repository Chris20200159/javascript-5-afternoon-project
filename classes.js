...
const chris = new Employee('Chris', 'Vaughn', 'sameguy@gmail.com', 35)
////////// PROBLEM 2 //////////
...
const manager = new Manager('Robert', 'Smith', 'newguy@gmail.com', 40)
////////// PROBLEM 3 //////////
...
class ProgressiveManager extends Manager {
  ...
  hire(employee){
    ...
    } if (this.reports.length >= 4 && this.reports.length < 11){
      this.title = 'Mostly Manager'
    } if (this.reports.length >= 11 && this.reports.length < 51){
      this.title = 'Manager'
    } if (this.reports.length >= 51 && this.reports.length < 101){
